...
label continue:
    ...
    """И вообще с самого дества я мечтал стать футболистом.
    
    Но родители меня сначала послали на танцы."""
    ...
    Я обажаю бегать по полю, вдыхая ароматы распустившихся цветов.
...
label case_factory_worker:
    ...
    menu:
        "Провести внеплановую проверку завода":
            $ rating += 2
