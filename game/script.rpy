...
label continue:
    ...
    Вода по анализам признана непригодной для питья и даже бытового использования.
    
    Уже поступили сообщения о случаях отравления — у людей проблемы с кожей, желудком, есть подозрения на массовое отравление детей.
    ...
    Прочтите обращения: люди в панике, некоторые фермеры всё отрицают. Но реальный корень — отсутствие очистительных сооружений и беспорядочное использование пестицидов.
    ...
    У вас три дня. Ситуация напряжённая, учитывая всё давление и… недовольство обычных жителей. До связи."""
...
label case_babushka:
    ...
    menu:
        "Спросить, когда начались проблемы":
            b "Да вот недели две как. Соседка тоже жалуется, у неё даже руки после мытья чешутся."
